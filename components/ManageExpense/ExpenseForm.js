    ...
    <View style={styles.form}>
      ...
      <Input
        ...
        textInputConfig={{
          keyboardType: "default",
          multiline: true,
          // autocorrect: false, // به صورت دیفالت ترو می باشد ولی جایی که ایمیل میخاییم باید فالس باشه
          //   autoCapitalize: none,
      ...
      />
      {formIsInvalid && (
        <Text style={styles.errorText}>Invalid input values - Please check you entered date!</Text>
      )}
